...
<!--[[ page specific plugins ]]-->
	...
	<?php 
$sql_destacada =  "SELECT * FROM sorteos order by id desc ";
...
?>
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title">Sorteos</h4>
									</div>
									<div class="panel_controls">
										<div class="row">
											...
											<div class="col-sm-2"><a href="sorteo.php" class="btn btn-success"> <i class="icon-plus-sign"></i> Nuevo Sorteo</div></a>
											
											<!--<div class="col-sm-2"><a href="factura.php" class="btn btn-success"> <i class="icon-plus-sign"></i> Nueva Factura</div></a>-->
										</div>
									</div>
										...
										<tbody>
										 <?php
											...
											while ($newArray = mysql_fetch_array($result_destacada)) {
												...
												if($activo==1){$status="<span style='color:#5BB531;'><strong>Activo</strong></span>";}
												if($activo==0){$status="<span style='color:#CC0000;'><strong>Inactivo</strong></span>";}
												
												
												 $sql_f = "SELECT * FROM usuarios WHERE id=$proveedor;"; 
												...
												$edit="<span class='tip' ><a href='sorteo.php?id=$id&edit=1' title='Editar' ><i class='icon-pencil'></i></a></span> ";
