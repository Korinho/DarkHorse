...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
			...
			<div class="logo">
            <a href="index.html">
                <img src="../images/horse.png" alt="" /> </a>
        </div>
            <form class="login-form" action="security.php" method="post">
                <h3 class="form-title">Inicie Sesión con su cuenta</h3>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Usuario" name="user" /> </div>
                </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Contraseña</label>
                    <div class="input-icon">
                        <i class="fa fa-lock"></i>
                        <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Contraseña" name="pass" /> </div>
                </div>
        ...
        <!-- END LOGIN -->
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright"> 2018 &copy; Dark Horse. </div>
        <!-- END COPYRIGHT -->
        <!--[if lt IE 9]>
