<?php 	/*include("valida.php"); */
				 	...
				 	<div class="col-lg-9 column">
				 		...
				 		<div class="padding-left">
							...
							<form id="save">
					 				...
					 				<div class="row">
										...
										<div class="col-lg-12">
					 						...
					 						<span class="pf-title">Resume Title</span>

					 						<div class="pf-field">

					 							<input placeholder="" type="text" name="resume" id="resume">
										...
										<div class="col-lg-12">
					 						...
					 						<div class="pf-field">
												...
												<input type="hidden" placeholder=""  name="idR" class="idR" />
												<input type="hidden" placeholder=""  name="accion" value="save" />
							...
							<div class="contact-edit">
					 			...
					 			<div class="border-title"><h3>Experience</h3><a  title="" class="experience"><i class="la la-plus"></i> Add Experience	 </a></div>

					 			<div class="edu-history-sec ex">
							...
							<div class="contact-edit">
					 			...
					 			<div class="border-title"><h3>Education</h3><a class="education" title=""><i class="la la-plus"></i> Add Education	 </a></div>

					 			<div class="edu-history-sec ed">
							...
							<div class="contact-edit">
					 			...
					 			<div class="border-title"><h3>Other</h3><a class="other" title=""><i class="la la-plus"></i> Add Other	 </a></div>

					 			<div class="edu-history-sec ot">
					 			...
					 			<form id="save2">
					 				...
					 				<div class="row">
					 					...
					 					<div class="col-lg-6">
					 						...
					 						<span class="pf-title">Desired Status</span>

					 						<select name="desired" id="desired" class="selectn" data-fv-field="lang">
					 					...
					 					<div class="col-lg-6">
					 						...
					 						<span class="pf-title">Display on web</span>
												...
												<input type="hidden" placeholder=""  name="accion" value="save2" />
												<input type="hidden" placeholder=""  name="idR" class="idR" />
					 					...
					 					<div class="col-lg-12">
					 						...
					 						<button type="button" onclick="save2();">Save</button>
	...
	function get(id){
		...
		success:function(data){
			...
			CKEDITOR.instances.summary.setData(summary);
			}
		}
	});
	}
