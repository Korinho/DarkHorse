$(document).on('ready',function(){
    ...
    $('.close-popup').on('click', function(){
        $('.signin-popup-box').fadeOut('fast');		$('.experience-popup-box').fadeOut('fast');		$('.aducation-popup-box').fadeOut('fast');		$('.other-popup-box').fadeOut('fast');
    ...
    $('.close-popup').on('click', function(){
        ...
        $('html').removeClass('no-scroll');
    });	$('.close-popup').on('click', function(){        $('.signin-popup-box').fadeOut('fast');		$('.experience-popup-box').fadeOut('fast');		$('.education-popup-box').fadeOut('fast');		$('.other-popup-box').fadeOut('fast');        $('html').removeClass('no-scroll');    });
