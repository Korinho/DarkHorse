						 		...
						 		<table>
						 			...
						 			<tbody>
										...
										<?php											
											...
											$id = 1;
											$vacantes = ctrVacantes::ctrMostrarPostulacionCandidato($id);
											...
											<tr>
												...
												<td>
													<span class="status active"><?php
													 $empresa = ControllerEmpleador::ctrGetEmpleador($value["id_employer"]);
													 echo $empresa["nombre"];
													  ?>													
													 </span>
												</td>
												<td>
													<ul class="action_job">
														<li><span>View Post</span><a href="vacancy.php?id=<?php echo $value['id'];?>" title=""><i class="la la-eye"></i></a></li>
														<li><span>Delete</span><a href="job.php?id=<?php echo $value['id']; ?>" title=""><i class="la la-eraser"></i></a></li>
													</ul>
												</td>
											</tr>
