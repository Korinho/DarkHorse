...
class ControllerEmpleador{


	public function registroEmpleador(){
	...
	if(isset($_POST["regUsuario"])){
			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["regPassword"])){
				...
				$respuesta = ModelCandidate::registroCandidato($tabla, $datos);
	...
	public function ctrGetEmpleador($id){

		$tabla="empleador";

		$respuesta = MdlEmpleador::MdlGetEmpleado($tabla,$id);
	...
	static public function ctrMostrarCandidato($item, $valor){
	...
	public function ctrOlvidoPassword(){
		...
		if(isset($_POST["passEmail"])){
			...
			if(preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["passEmail"])){
				...
				$respuesta1 = ModeloUsuarios::MostrarCandidato($tabla, $item1, $valor1);
				...
				if($respuesta1){
					...
					$respuesta2 = ModeloUsuarios::ActualizarCandidato($tabla, $id, $item2, $valor2);
	...
	static public function ctrRegistroRedesSociales($datos){
		...
		if($respuesta0){
			...
			$respuesta1 = ModeloUsuarios::RegistroCandidato($tabla, $datos);
	...
	public function ctrActualizarPerfil(){
		...
		if(isset($_POST["editarNombre"])){
			...
			$respuesta = ModeloUsuarios::ActualizarPerfilCandidato($tabla, $datos);
